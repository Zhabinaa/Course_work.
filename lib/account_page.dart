...
import 'package:flutter_application_2/addition/alert_adress_addition%20copy%202.dart';
import 'package:flutter_application_2/addition/alert_adress_editing.dart';
import 'package:flutter_application_2/addition/alert_cards_addition%20copy.dart';
import 'package:flutter_application_2/addition/alert_cards_editing%20copy.dart';
        ...
        Expanded(
          ...
          child: Container(
            ...
            decoration: const BoxDecoration(
                color: Color.fromARGB(255, 153, 121, 234),
                        ...
                        onPressed: () {
                          showDialog(
                            ...
                            builder: (context) => AlertDialog(
                              backgroundColor:
                                  const Color.fromARGB(255, 234, 121, 158),
                              title: const Text(
                                'Изменить почту',
                                style: TextStyle(
